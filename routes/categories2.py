...
@router_category2.post('/category2_add_from_admin')
...
@router_category2.get('/get',status_code=200)
...
@router_category2.put('/category2_update_from_admin',)
...
@router_category2.delete('/category2_delete_from_admin',)
