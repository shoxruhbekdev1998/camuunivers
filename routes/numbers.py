...
@router_number.post('/number_add_from_admin')
...
@router_number.get('/get',status_code=200)
...
@router_number.put('/number_update_from_admin',)
...
@router_number.delete('/nuber_delete_from_admin',)
